...
function getMessages(){
  ...
  $resultats = $db->query("SELECT * FROM messages ORDER BY created_at DESC LIMIT 3");
...
function postMessage(){
  ...
  if ($bool) 
  {
    ...
    Désolé message non registrer  <strong> veillez vous inscrir avant". var_dump($author) ." <a href=\"#\">ici<a> </strong> 
    <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\" style=\"outline:none;\">
      <span aria-hidden=\"true\">&times;</span>
    </button>
    </div>";   
